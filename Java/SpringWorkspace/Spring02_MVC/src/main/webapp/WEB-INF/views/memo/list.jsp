...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
	...
	<div class="container mt-4">
		<h1 class="text-center">::한줄메모장 목록::</h1>
		<br><br>
		<div class="text-center">
			<span>총 게시글 수 : ${totalCount}개</span>,
			<span class="text-danger"> 현재 ${cpage} 페이지</span> / 총 ${pageCount} pages
		</div>
		<br><br>
		<table class="table">
			<tr>
				...
				<c:forEach var="memo" items="${memoArr}">
					<tr>
						...
						<td>
							...
							<span><c:out value="[${memo.wdate}]"/></span>
						</td>
	...
	<script>
		function del(no){
			...
			//location.href='memoDelete?idx='+no; //get방식
			df.idx.value=no;
			df.submit();
			//alert(no);
		}

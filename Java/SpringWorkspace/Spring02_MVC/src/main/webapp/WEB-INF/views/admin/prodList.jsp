...
<div class="container mt-5" id="content">
	...
	<h1 class="text-center m-4">상품 목록 - Product List Page</h1><br>
				...
				<c:forEach var="item" items="${prodArr}">
					<tr>
						...
						<td>
							...
							판매가 : <fmt:formatNumber value="${item.saleprice}" pattern="###,###"/>
							</b><br>
							
							<span class="badge badge-danger">
								<c:out value="${item.percent}"></c:out>
							%할인
							</span>
						</td>
						<td>
	...
	<!-- 수정 또는 삭제 FORM --------------------------------------->
	<form name="pf" method="post" id="pnum">

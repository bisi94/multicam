...
<!-- -------------------------------------------- -->
	...
	<div class="container">
		<h1>Signup Page</h1>
		<br><br>
		<!-- signupEnd.do는 서블릿의 url-mapping시 url pattern으로 등록할 예쩡 -->
		<form name="mf" action="signupEnd.do" method="post">
		...
		<table border="1" id=userTable>
				...
				<tr>
					<th>우편번호</th>
					<td>
						<input type="text" name="post" id="post" class="post" readonly>
				...
				<tr>
					<th>주소</th>
					<td>
						<input type="text" name="addr1" id="addr1" class="addr" readonly><br>
				...
				<tr>
					...
					<iframe src="<%=request.getContextPath() %>/member/agree.html" width="90%" height="120px"></iframe>
